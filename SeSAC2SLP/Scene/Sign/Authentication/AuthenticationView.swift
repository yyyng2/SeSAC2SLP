...
class AuthenticationView: BaseView {
    ...
    let sendTextMessageButton: CustomSignButton = {
    ...
    override func configure() {
        ...
        [authenticationViewInfoLabel, phoneNumberTextField, sendTextMessageButton].forEach {
            self.addSubview($0)
        }
    }
    ...
    override func setConstraints() {
        ...
        sendTextMessageButton.snp.makeConstraints { make in
            make.centerX.equalTo(safeAreaLayoutGuide)
